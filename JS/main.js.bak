...
async function videoCloser() {
   $(".entry-video-container").animate({
      top: "-100vh"
   }, 500);
   await wait(500);
   $(".entry-video-container").remove();
}
...
var logArr = [`console.log('%c Bu siteyi yaptıran adam sitenin bilgisayardan kullanılmasını istiyor ', 'background: #000; color: #fff');`, `
console.log('%c Bu siteyi yaptıran adam sitenin kaynağından fotoğrafların alınmasını istemiyor ', 'background: #f00; color: #fff');`, `
console.log('%c Bu siteyi yapan adama @ysrkaanky instagram adresinden veya ysrkaanky@gmail.com adresinden ulaşabilirsiniz  ', 'background: #00f; color: #fff');`, `console.log('%c İyi İncelemeler =)  ', 'background: #070; color: #fff');`];
